      ...
      <div className={SIDEBAR_CLASSES.desktop}>
        <div className='p-5 border-b border-amber-100 lg:block hidden'>
          <div className='flex items-center gap-3'>
            <div className='w-10 h-10 rounded-full bg-gradient-to-br from-yellow-500 to-amber-600
            ...
            <div className={TIP_CARD.container}>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <a href='https://roshan-sharma-portfolio.vercel.app/#projects' target="_blank" className='block mt-2 text-sm
                  text-amber-500 hover:underline'>
                    Visit Admin more Pprojects
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className='fixed inset-0 z-40'>
          ...
          <div className={SIDEBAR_CLASSES.mobileDrawer} onClick={(e) => e.stopPropagation()}>
            <div className='flex justify-between items-center mb-4 border-b pb-2'>
              ...
              <button onClick={() => setMobileOpen(false)} className='text-gray-700 hover:text-amber-600'>
                <X className='w-5 h-5' />
              </button>
            </div>
